...
describe("query", function() {
  ...
  it("should return false when employee's details and date is not available ", function() {
    ...
    let data =
      '[{"empId":"25323","beverage":"orange","qty":"1","date":"2019-11-25T18:27:52.164Z"},{"empId":"25323","beverage":"orange","qty":"2","date":"2019-11-25T18:27:52.700Z"}]';
    let expected = {
      beveragesData: JSON.parse(data),
      transactionDetails: [
        "Employee ID,Beverage,Quantity,Date\n",
  ...
  it("should return the beverages on date and total beverages when date is given and not empId ", function() {
    ...
    let data =
      '[{"empId":"25323","beverage":"orange","qty":"1","date":"2019-11-26T18:27:52.164Z"},{"empId":"25555","beverage":"orange","qty":"2","date":"2019-11-25T18:27:52.700Z"}]';
    let expected = {
      beveragesData: JSON.parse(data),
      transactionDetails: [
        "Employee ID,Beverage,Quantity,Date\n",
  ...
  it("should return the beverages of emp on date when both empId and date is given", function() {
    ...
    const data =
      '[{"empId":"25323","beverage":"orange","qty":"1","date":"2019-11-26T18:27:52.164Z"},{"empId":"25555","beverage":"orange","qty":"2","date":"2019-11-25T18:27:52.700Z"},{"empId":"25555","beverage":"pineapple","qty":"5","date":"2019-11-27T18:27:52.700Z"}]';
    const expected = {
      beveragesData: JSON.parse(data),
      transactionDetails: [
        "Employee ID,Beverage,Quantity,Date\n",
  ...
  it("should return beverages when all beverage, emp, date is given", function() {
    ...
    const data =
      '[{"empId":"25555","beverage":"orange","qty":"1","date":"2019-11-25T18:27:52.164Z"},{"empId":"25555","beverage":"pineapple","qty":"1","date":"2019-11-27T18:27:52.164Z"},{"empId":"25555","beverage":"water melon","qty":"1","date":"2019-11-25T18:27:52.164Z"}]';
    const expected = {
      beveragesData: JSON.parse(data),
      transactionDetails: [
        "Employee ID,Beverage,Quantity,Date\n",
